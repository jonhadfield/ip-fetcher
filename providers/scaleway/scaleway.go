...
var ASNs = []string{"12876"} //nolint:nolintlint,gochecknoglobals
...
func (h *Scaleway) FetchData() ([]byte, http.Header, int, error) {
	var (
		headers http.Header
		status  int
		err     error
...
func (h *Scaleway) Fetch() (Doc, error) {
...
func ProcessData(data []byte) (Doc, error) {
	...
	if err != nil {
		return Doc{}, fmt.Errorf("error unmarshalling Scaleway doc: %w", err)
	}
